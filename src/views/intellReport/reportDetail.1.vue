...
<div class="dataDetail" v-loading.fullscreen="loading">
    ...
    <div class="dataBox">
        <div class="filterSection">
            ...
            <div class="filterPart" style="width:100%"><div class="verticalBar"></div>报告内容<!--p class="decoText">Contents of the report</p--></div>
            ...
            <div class="dataRight">
				...
				<div class="dataItem" v-for="(item,index) in reportDetailList" :key="index" >
					...
					<p class="contentItem" v-if='item.mm !="暂无数据"'>
						...
						同比下降{{item.mmYn[index].tb?Number(item.mmYn[index].tb.toFixed(5)) * 100:'-'}}%。</p>
